...
function addToppingsAttribute() {
	jQuery( "<div class='complete-row-base'><div class=col-lg-3><select class=form-control id=size name=sizeToppings[]><option value=small>Small<option value=medium>Medium<option value=large >large</select></div><div class='col-lg-3'><input type='text' name='toppings_base[]' placeholder='Toppings' class='form-control'></div><div class='col-lg-3'><input type='text' name='toppings_price[]' class='form-control' placeholder='Price'></div><div class='col-lg-3'><button type='button' class='btn btn-danger' onclick='deleteCurrentRowToppings(this)'>Delete</button></div></div>" ).insertAfter( ".complete-row-toppings:last" );
}
